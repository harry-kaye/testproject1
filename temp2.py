def get_country_code(country_name):
    ...
    return get_country_code.get(country_name, "Unknown")

def getcountrycode():
    # Prompt the user to input a country
    #city_name = input("Enter the name of the city: ")
    country_name = input("Enter the name of the country: ")
    print("breakpoint", country_name)
    countrycode=get_country_code(country_name)
